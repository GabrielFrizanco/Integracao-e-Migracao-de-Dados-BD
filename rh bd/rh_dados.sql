...
/* tabela ESTADOS */
insert into estados(id_estado, sg_estado, ds_estado) values(1,'SP','SÃO PAULO');
insert into estados(id_estado, sg_estado, ds_estado) values(2,'RJ','RIO DE JANEIRO');
insert into estados(id_estado, sg_estado, ds_estado) values(3,'MG','MINAS GERAIS');
insert into estados(id_estado, sg_estado, ds_estado) values(4,'PR','PARANA');
insert into estados(id_estado, sg_estado, ds_estado) values(5,'SC','SANTA CATARINA');
insert into estados(id_estado, sg_estado, ds_estado) values(6,'PA','PARA');
insert into estados(id_estado, sg_estado, ds_estado) values(7,'CE','CEARA');
insert into estados(id_estado, sg_estado, ds_estado) values(8,'RS','RIO GRANDE DO SUL');
insert into estados(id_estado, sg_estado, ds_estado) values(9,'MA','MARANHAO');
insert into estados(id_estado, sg_estado, ds_estado) values(10,'PE','PERNAMBUCO');
insert into estados(id_estado, sg_estado, ds_estado) values(11,'SE','SERGIPE');
insert into estados(id_estado, sg_estado, ds_estado) values(12,'BA','BAHIA');
...
/* TABELA FUNCIONARIOS  */
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (1,'ROBERTO MENDES','FORMADO EM ENGENHARIA PELA FUNDAÇÃO ABC','roberto@gmail.com','www.roberto.com.br','1971/09/15',20,500,2000,1,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (2,'EDSON OLAVO SILVA','ATUA SEMPRE COM COMPETENCIA NAS ATIVIDADES','edson.silva@hotmail.com','www.edsonsilva.com','1968/06/20',50,505,4000,1,2);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (3,'SIMONE ALMEIDA PRADO','FORMADA PELA FGV','simone@hotmail.com','www.simonedra.com','1986/08/10',90,525,5000,2,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (4,'CARLA SANTOS','EXCELENTE EXECUTIVA','carlinha@hotmail.com','www.carlinha.com','1988/03/20',20,538,2000,2,1);
insert into funcionarios(id_funcionario, nm_funcionario, ds_apresentacao, ds_email, ds_site, dt_nascimento, id_cargo, id_cidade, id_departamento, id_genero, id_status) values (5,'ROSANGELA BRAVO','CURSANDO ADMINISTRACAO','ro@hotmail.com','www.ro.com','1980/04/09',10,540,2000,2,3);

/* TABELA DEPENDENTES  */
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (1,'MARIA ALICE MENDES',1,'1974/08/15',90,2,10);
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (2,'MARTA MENDES',1,'1999/04/20',91,2,10);
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (3,'MARCIA MENDES',1,'1999/04/20',91,2,10);
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (4,'TEOBALDO MENDES',1,'2005/12/25',91,1,11);
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (5,'SIMONE SANTOS SILVA',2,'1970/03/14',90,2,06);
insert into dependentes(id_dependente,nm_dependente,id_funcionario,dt_nascimento,id_grau,id_genero,id_estado) values (6,'CARLOS BRAVO',5,'2015/08/13',91,1,3);

/* TABELA HISTORICO  */
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (700,800,1,'2020/09/20','OTIMO DESEMPENHO');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (701,800,1,'2021/10/21','COMPROMETIMENTO');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (702,803,1,'2022/02/15','DESEMPENHO ACIMA DA MEDIA');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (703,800,3,'2019/08/15','ATIVIDADES EXECUTADAS COM SUCESSO');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (704,807,3,'2021/02/18','DESEMPENHO ACIMA DA MEDIA');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (705,809,3,'2022/08/10','DISCUSSAO COM MEMBRO DA EQUIPE');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (706,811,4,'2022/08/18','NAO ACATOU A ORDEM');
insert into historico(id_historico, id_ocorrencia, id_funcionario, dt_historico, ds_observacao) values (707,812,4,'2022/08/17','PROBLEMAS DE SAUDE');
